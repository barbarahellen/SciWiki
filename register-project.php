...
id="email" placeholder="Enter your e-mail" required maxlength="50">
                            ...
                            <div class="mb-3">
                                <label for="fullname" class="form-label" name='name'>Name of the project</label>
                                <input type="text" class="form-control" id="fullname" placeholder="Enter the name" required maxlength="50">
                            </div>
                          
                            <div class="mb-3">
                               <label for="description" class="form-label" name='description'>Description</label>
            <textarea class="form-control" id="description" placeholder="Enter your description" required style="width: 100%; max-width: 100%;" rows="4"></textarea>
                            </div>
                          <div class="mb-3">
                                <label for="choose" class="form-label">What habilities are your looking for?</label>
                                <div class="choose-group">
                                
                              

                                  <div class="choose-input">
                                    <input type="checkbox" id="full-stack" name="select">
                                    <label for="full-stack">Full-stack</label>
                                  </div>

                                  <div class="choose-input">
                                    <input type="checkbox" id="designer" name="select">
                                    <label for="designer">Designer</label><br>
                                  </div>
                                
                                  <div class="choose-input">
                                    <input type="checkbox" id="data" name="select">
                                    <label for="data">Data Scientist</label>
                                  </div>

                            

                                  <div class="choose-input">
                                    <input type="checkbox" id="others" name="select">
                          ...
                          <div class="mb-3">
                            ...
                            <a class="btn btn-dark" href="pesquisar.php" role="button">Finish</a>
